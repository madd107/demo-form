...
$(document).ready(function () {
  ...
  function addRowData(out_elm, id, username, phone, mon) {
    let rowData =
      "<tr> <td>" +
      id +
      "</td>    <td>" +
      ...
      id +
      '">        <i class="far fa-edit"></i>      </button>      <button id="btn-del" class="btn btn-outline-primary btn-sm">        <i class="far fa-trash-alt"></i>      </button>    </td>  </tr>';

    out_elm.append(rowData);
  }

  function addDatatoArray(arrObj, field_1, field_2, field_3) {
    var last_id = 0;
  ...
  function deleteData(arrObj, id) {}

  //Bat su kien sau khi them button
