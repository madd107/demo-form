...
$(document).ready(function () {
  ...
  function displayData(out_elm) {
    ...
    rowData +=
      '<td><button class="btn btn-outline-warning btn-sm" id="btn-edit"><i class="fas fa-edit"></i></button> <button class="btn btn-outline-danger btn-sm" id="btn-del"><i class="fa fa-trash"></i></button></td>';
