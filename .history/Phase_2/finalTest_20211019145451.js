$(document).ready(function () {
  ...
  function validateLop(str_khoi_input, str_lop_input, str_valid) {
  ...
  function validateKhoi(str_khoi_input, str_lop_input, str_valid) {
    if (parseInt(str_lop_input.val()) == 10) {
      if (parseInt(str_khoi_input.val()) != 10) {
        str_valid.html("Information Invalid");
        return true;
      }
    } else if (parseInt(str_lop_input.val()) == 11) {
      if (parseInt(str_khoi_input.val()) != 11) {
        str_valid.html("Information Invalid");
        return true;
      }
    } else if (parseInt(str_lop_input.val()) == 12) {
      if (parseInt(str_khoi_input.val()) != 12) {
        str_valid.html("Information Invalid");
        return true;
      }
    } else if (str_khoi_input.val() == "") {
      str_valid.html("Information Invalid");
      return true;
    } else {
      return false;
  ...
  $("#lop").change(function (e) {
    ...
    if (validateLop($("#khoi"), $("#lop"), $("#val_lop"))) {
    } else {
      $("#val_lop").html("");
    }
  });
  ...
  $("#khoi").change(function (e) {
    e.preventDefault();
    if (validateKhoi($("#khoi"), $("#lop"), $("#val_lop"))) {
    } else {
      $("#val_lop").html("");
    }
  });
