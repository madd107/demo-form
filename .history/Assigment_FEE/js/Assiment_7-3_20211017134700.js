  ...
  $("#sign-in").on("click", function (event) {
    ...
    (function () {
      if (
        ...
        isCheck(validData, $("#last-n"), $("#last-nError")) ||
        isCheck(validData, $("#address"), $("#addrError")) ||
        isCheck(validData, $("#city"), $("#cityError")) ||
        isCheck(validData, $("#name-on-card"), $("#name-on-cardError"))
      ) {
        return;
      } else {
        // $("#first-nError").html("");
