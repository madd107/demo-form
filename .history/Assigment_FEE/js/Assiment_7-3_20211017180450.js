$(document).ready(function () {
  ...
  $("#sign-in").on("click", function displayData(event) {
  ...
  function editBtn(arrObj, id) {
    var index = arrObj.findIndex((data) => data.cc_number == id);
    fname = arrObj[index].first_name;
    lname = arrObj[index].last_name;
    eMail = arrObj[index].mail;
    foneNumber = arrObj[index].phone;
    addr = arrObj[index].address;
    cty = arrObj[index].city;
    sta = arrObj[index].state;
    zipCode = arrObj[index].zip_code;
    nameOnCard = arrObj[index].name_on_card;
    creditCardNum = arrObj[index].cc_number;
    eMonth = arrObj[index].exp_month;
    eYear = arrObj[index].exp_year;
    cVV = arrObj[index].cvv;
  }
});
