window.onload = function () {
  ...
  if (all.addEventListener("click", showAll)) {
    cake.removeEventListener("click", showCakes);
    cake.classList.remove("btn-danger", "active");
  ...
  } else if (cake.addEventListener("click", showCakes)) {
    sweet.removeEventListener("click", showSweets);
    cupCake.removeEventListener("click", showCupCake);
    doughnut.removeEventListener("click", showDoughnut);
    all.removeEventListener("click", showAll);
  } else if (sweet.addEventListener("click", showSweets)) {
    cupCake.removeEventListener("click", showCupCake);
    doughnut.removeEventListener("click", showDoughnut);
    all.removeEventListener("click", showAll);
    cake.removeEventListener("click", showCakes);
  } else if (cupCake.addEventListener("click", showCupCake)) {
    doughnut.removeEventListener("click", showDoughnut);
    all.removeEventListener("click", showAll);
    cake.removeEventListener("click", showCakes);
    sweet.removeEventListener("click", showSweets);
  } else if (doughnut.addEventListener("click", showDoughnut)) {
    all.removeEventListener("click", showAll);
    cake.removeEventListener("click", showCakes);
    sweet.removeEventListener("click", showSweets);
    cupCake.removeEventListener("click", showCupCake);
  ...
  function showAll() {
    ...
    listCake.forEach((list) => {
      ...
      all.classList.add("btn-danger", "active");
      cake.classList.remove("btn-danger", "active");
      sweet.classList.remove("btn-danger", "active");
      cupCake.classList.remove("btn-danger", "active");
      doughnut.classList.remove("btn-danger", "active");
  ...
  function showCakes() {
    ...
    cakes.forEach((list) => {
      ...
      cake.classList.add("btn-danger", "active");
      all.classList.remove("btn-danger", "active");
      sweet.classList.remove("btn-danger", "active");
      cupCake.classList.remove("btn-danger", "active");
      doughnut.classList.remove("btn-danger", "active");
  ...
  function showSweets() {
    ...
    sweets.forEach((list) => {
      ...
      sweet.classList.add("btn-danger", "active");
      all.classList.remove("btn-danger", "active");
      cake.classList.remove("btn-danger", "active");
      cupCake.classList.remove("btn-danger", "active");
      doughnut.classList.remove("btn-danger", "active");
  ...
  function showCupCake() {
    ...
    cupCakes.forEach((list) => {
      ...
      cupCake.classList.add("btn-danger", "active");
      all.classList.remove("btn-danger", "active");
      cake.classList.remove("btn-danger", "active");
      sweet.classList.remove("btn-danger", "active");
      doughnut.classList.remove("btn-danger", "active");
  ...
  function showDoughnut() {
    ...
    doughts.forEach((list) => {
      ...
      doughnut.classList.add("btn-danger", "active");
      all.classList.remove("btn-danger", "active");
      cake.classList.remove("btn-danger", "active");
      sweet.classList.remove("btn-danger", "active");
      cupCake.classList.remove("btn-danger", "active");
  ...
  form.addEventListener("submit", function (event) {
    ...
    listCake.forEach((list) => {
      if (list.type == findCake.value) {
        show.innerHTML = "";
        var daTimRa = listCake.filter((lCake) => lCake.type == findCake.value);
        daTimRa.forEach((l) => {
          var col = document.createElement("div");
          col.classList.add("col-4", "mb-3");
          var card = document.createElement("div");
          ...
          var title = document.createElement("h5");
          title.classList.add("card-title");
          title.innerHTML = l.type;
          var gia = document.createElement("h5");
          gia.innerHTML = l.price;
  ...
  // Tim banh theo keyup
  findCake.removeEventListener("keyup", findKey);
  findCake.addEventListener("keyup", findKey);
  function findKey() {
    listCake.forEach((list) => {
      if (list.type.includes(findCake.value)) {
        show.innerHTML = "";
        var daTimRa = listCake.filter((l) => l.type.includes(findCake.value));
        daTimRa.forEach((showList) => {
          var col = document.createElement("div");
          col.classList.add("col-4", "mb-3");
          var card = document.createElement("div");
          card.classList.add("card");
          var img = document.createElement("img");
          img.classList.add("card-img-top");
          img.src = showList.imageCake;
          var a = document.createElement("a");
          a.classList.add("card-body", "d-flex", "justify-content-between");
          var title = document.createElement("h5");
          title.classList.add("card-title");
          title.innerHTML = showList.type;
          var gia = document.createElement("h5");
          gia.innerHTML = showList.price;
