window.onload = function () {
  ...
  const text = document.querySelector("#input-info");
  ...
  form.addEventListener("submit", function (event) {
    ...
    // Tạo hàm loadList()
    function loadList() {
      // Dòng code này là để gán 1 phân vùng rỗng mới. Có nghĩa là nó clear những giá trị đã đc thêm vào trước đó và tạo 1 vùng rỗng mới để mình có thể thêm các row vào. Nếu ko có đoạn code này sẽ gặp lỗi đúp các row đã thêm trc đó và các lệnh edit, del, clear cũng sẽ lỗi
      list.innerHTML = "";
    ...
    function handleEdit() {
      ...
      // Bước này là để đẩy phần thông tin cần chỉnh sửa lên ô input để có thể chỉnh sửa.
    ...
    //   // Clear toàn bộ danh sách bằng việc gán 1 mảng rỗng lại cho List
    //   todoList = [];
