window.onload = function () {
  ...
  var taskText = document.querySelector("#input-info");
  ...
  form.addEventListener("submit", function (event) {
    ...
    if (isNotNull(taskText.value) == false) {
    ...
    todoList.push({
      ...
      record: taskText.value, // Bước này là gán dữ liệu vừa nhập ở ô input vào thuộc tính record để phía dưới thêm vào từng row.
    });
    ...
    function handleEdit() {
      ...
      taskText.value = todoList[index].record;
