$(document).ready(function () {
  ...
  function check(a, str, errMsg) {
    if (a(str.value()) == false) {
  ...
  $("#sign-in").on("click", function (event) {
    ...
    check(validData, $("#first-n"), $("#first-nError"));
    check(validData, $("#last-n"), $("#last-nError"));

    // if (validData($("#first-n").text() == false)) {
    //   document.querySelector("#first-nError").innerHTML = "Information Invalid";
    //   return;
    // }

    // if (validData($("#last-n").text() == false)) {
    //   document.querySelector("#last-nError").innerHTML = "Information Invalid";
    //   return;
    // }
    // if (validData($("#address").text() == false)) {
    //   document.querySelector("#addrError").innerHTML = "Information Invalid";
    //   return;
    // }
    // if (validData($("#city").text() == false)) {
    //   document.querySelector("#cityError").innerHTML = "Information Invalid";
    //   return;
    // }
    // if (validData($("#name-on-card").text() == false)) {
    //   document.querySelector("#name-on-cardError").innerHTML =
    //     "Information Invalid";
    //   return;
    // }

    console.log($("#first-n").text());
