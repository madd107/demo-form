  ...
  function addRowData(out_elm) {
    arrData.forEach((obj) => {
      let rowData =
        ...
        "</td>    <td>" +
        obj.field_1 +
        '</td>    <td>oiqhd</td>    <td>oqiwore</td>    <td>38743</td>    <td>maoihf</td>    <td>937763267439</td>    <td>12</td>    <td>2020</td>    <td>721</td>    <td>      <button id="btn-edit" class="btn btn-outline-primary btn-sm">        <i class="far fa-edit"></i>      </button>      <button id="btn-del" class="btn btn-outline-primary btn-sm">        <i class="far fa-trash-alt"></i>      </button>    </td>  </tr>';
    });
  }
